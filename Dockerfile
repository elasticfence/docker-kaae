...
RUN apt-get update && apt-get clean \
 ...
 && cd /tmp && wget https://download.elastic.co/kibana/kibana/kibana-4.6.0-linux-x86_64.tar.gz \
 && tar zxvf /tmp/kibana-4.6.0-linux-x86_64.tar.gz && mv kibana-4.6.0-linux-x86_64 /opt/kibana \
